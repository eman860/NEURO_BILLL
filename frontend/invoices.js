...
function renderInvoiceTable(invoices) {
    ...
    <table>
      <thead>
        <tr><th>#</th><th>Customer</th><th>Supply</th><th>Grand Total</th><th>Paid</th><th>Outstanding</th><th>Status</th><th>Actions</th></tr>
      </thead>
      <tbody>
        ${invoices.map(inv => `
        <tr>
...
async function viewInvoice(id) {
    ...
    <div class="invoice-print" id="inv-print-area">
      ...
      <table>
        <thead>
          <tr>
            <th>#</th><th>Product</th><th>Qty</th><th>Rate</th><th>Taxable</th>
